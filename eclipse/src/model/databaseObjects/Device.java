...
public class Device extends StockObject {
	...
	public Device(int id, String title, String description, int minimumStock, int quotaStock, Boolean silencedWarnings, Type type,
				  String serialNumber, String inventoryNumber, String umdns, int mtkIntervall, int stkIntervall) {
		// call super Constructor
		super(id, title, description, minimumStock, quotaStock, silencedWarnings, type);
