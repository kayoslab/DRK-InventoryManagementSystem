...
public class MedicalMaterial extends Material {
	...
	public MedicalMaterial(int id, String title, String description, Boolean silencedWarnings, DatabaseObject.StockObjectType type, int batchSize, int minimumStock, int quotaStock) {
